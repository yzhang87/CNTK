...
namespace msra {
    namespace dbn {
        ...
        // ---------------------------------------------------------------------------
        class BundlerSplitted : public Microsoft::MSR::CNTK::Sequencer
        {
        ...
        public:
            BundlerSplitted::BundlerSplitted(const Microsoft::MSR::CNTK::ConfigParameters& readerConfig, bool framemode, size_t elementSize);
