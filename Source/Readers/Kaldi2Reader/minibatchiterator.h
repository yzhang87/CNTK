...
public:
                          ...
                          std::vector<shared_ptr<const latticesource::latticepair>> &lattices)
    {
        ...
        subsetnum;
        numsubsets;
        bool retVal = getbatch(globalts, framesrequested, feat, uids, utteranceinfo, transcripts, lattices);
...
private:
    ...
    void fillorclear()
    {
        ...
        source.getbatch(mbstartframe, requestedframes, subsetnum, numsubsets, mbframesadvanced, featbuf, uids, utteranceinfo, transcripts, lattices);
...
public:
    ...
    size_t currentmbutterances() const
    {
        return utteranceinfo.size();
    }
